    ...
    <View style={styles.container}>
        ...
        {bankAccounts.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtitle}>
              You haven't added any bank accounts yet. Tap the button below to add your first account.
            </Text>
          </View>
        ) : (
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity style={styles.addButton}>
          ...
          <Link href='/(tabs)/JobPoster/createbankaccount'><Text style={styles.addButtonText}>Add New Bank Account</Text></Link>
        </TouchableOpacity>
      </View>
    </View>
  );
