...
const PaymentPage = () => {
  ...
  const [bankAccounts, setBankAccounts] = useState([
    { id: '1', name: 'Chase Checking', accountNumber: '****1234', bankName: 'Chase Bank' },
    { id: '2', name: 'Wells Fargo Savings', accountNumber: '****5678', bankName: 'Wells Fargo' },
  ]);
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.paymentMethodContainer}>
            ...
            >
              <View style={[styles.radioButton, selectedPaymentMethod === 'card' && styles.radioSelected]} />
            ...
            >
              <View style={[styles.radioButton, selectedPaymentMethod === 'skrill' && styles.radioSelected]} />
            ...
            >
              <View style={[styles.radioButton, selectedPaymentMethod === 'bank' && styles.radioSelected]} />
            ...
            <View style={styles.skrillContainer}>
              ...
              <View style={styles.alternativePaymentContainer}>
                <Text style={styles.alternativePaymentText}>
                  You will be redirected to Skrill to complete your payment securely.
                </Text>
              </View>
            </View>
          )}
          ...
          {selectedPaymentMethod === 'bank' && (
            <View style={styles.bankAccountContainer}>
              ...
              {selectedBankAccount && (
                <View style={styles.alternativePaymentContainer}>
                  <Text style={styles.alternativePaymentText}>
                    Payment will be processed through your selected bank account.
                  </Text>
                </View>
              )}
            </View>
          ...
          <TouchableOpacity style={styles.payButton}>
            <Link href="/(tabs)/JobPoster/paymentsuccess"><Text style={styles.payButtonText}>Pay $17.99</Text></Link>
          </TouchableOpacity>
        </View>
      </ScrollView>
