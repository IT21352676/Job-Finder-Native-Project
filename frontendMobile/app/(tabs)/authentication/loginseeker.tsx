    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          ...
          <ImageBackground
            source={{
              uri: "https://img.freepik.com/free-photo/job-hiring-vacancy-team-interview-career-recruiting_53876-121268.jpg?semt=ais_items_boosted&w=740",
            }}
            style={styles.header}
            resizeMode="cover"
          >
          ...
          <View style={styles.loginCard}>
            {/* Login Title */}
            <Text style={styles.loginTitle}>Login as a Job Seeker</Text>
            ...
            <View style={styles.signUpContainer}>
              ...
              <TouchableOpacity onPress={handleSignUp} activeOpacity={0.7}>
                <Text style={styles.signUpLink}>
                  <Link href="/authentication/registerseeker">Sign Up</Link>
                </Text>
              </TouchableOpacity>
            </View>
          </View>
