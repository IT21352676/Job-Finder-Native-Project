...
const ProfileScreen = () => {
    ...
    const fetchPosterDetails = async () => {
      try {
        const res = await fetch(
          `http://localhost:8000/mobile/secured/job-seeker/retrieve-profile-picture/${userData?.id}`,
          {
            method: "GET",
            headers: {
        ...
        const blob = await res.blob(); // ✅ get binary data
        const imageUrl = URL.createObjectURL(blob); // ✅ convert to URL for <Image>
  ...
  const user = {
    ...
    avatar:
      "https://media.licdn.com/dms/image/v2/D5603AQFxEGz9TZHpng/profile-displayphoto-shrink_800_800/B56Zc1UO8ZG0Ac-/0/1748946188120?e=1757548800&v=beta&t=HsAhTqxaQ2zi7d53aFuMrPhRwrYJQbJFlWgKqdSRnMA",
    resumeUploaded: true,
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity>
            <Link href="/(tabs)/JobSeeker/editprofile">
