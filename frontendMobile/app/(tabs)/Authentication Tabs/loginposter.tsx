    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          ...
          <ImageBackground
            source={{ uri: 'https://img.freepik.com/premium-photo/woman-presenting-her-resume-interview_249974-12408.jpg?semt=ais_hybrid&w=740' }}
            style={styles.header}
            resizeMode="cover"
          >
          ...
          <View style={styles.loginCard}>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.8}
            >
              <Text style={styles.jobPosterButtonText}><Link href="/(tabs)/loginseeker">Login in as Job Seeker</Link></Text>
            </TouchableOpacity>
            ...
            <View style={styles.signUpContainer}>
              ...
              <TouchableOpacity onPress={handleSignUp} activeOpacity={0.7}>
                <Text style={styles.signUpLink}><Link href="/(tabs)/registerposter">Sign Up</Link></Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
